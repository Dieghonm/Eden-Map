...
export const VIDEOS = [
  ...
  { 
    ...
    sinopse: [
      ...
      'gratidão',
      ' muda emoções, fortalece o cérebro e ',
      'abre a primeira fase',
      ' da sua jornada.'
    ]
  },
  { 
    ...
    sinopse: [
      ...
      'perfeccionismo',
      ' trava sua vida e mostra passos práticos para ',
      'agir',
  ...
  { 
    ...
    sinopse: [
      'Descubra como a ',
      'atenção plena molda o cérebro',
      ', fortalece conexões, quebra padrões antigos, ',
      'reduz o estresse',
      ' e amplia a clareza.'
    ]
  },
  { 
    ...
    sinopse: [
      ...
      'e transformar sua realidade interna.'
    ]
  },
  { 
    id: 6, 
    ...
    sinopse: [
      ...
      'identificar, reestruturar e sustentar mudanças',
      ' para transformar ',
      'crenças limitantes',
      ' em força interior.'
    ]
  ...
  { 
    ...
    sinopse: [
      ...
      ' nos afasta de nós mesmos e como o ',
      'silêncio',
      ' recupera foco, clareza e direção interior.'
    ]
  },
  { 
    id: 8, 
    ...
    sinopse: [
      ...
      'identidades e máscaras sociais',
      ', revelando como o Eden Map ajuda você a ',
      'reencontrar',
      ' seu eu autêntico.'
    ]
  },
  { 
    ...
    sinopse: [
      ...
      'visualização',
      ' reprograma o subconsciente, cria ',
      'novos padrões neurais',
      ' e aproxima seus desejos da realidade.'
    ]
  },
  { 
    id: 10, 
    ...
    sinopse: [
      ...
      ' e como avançar passo a passo sem esperar estar pronto.'
    ]
  },
  { 
    id: 11, 
    ...
    sinopse: [
      ...
      'prazos invisíveis',
      ', critica padrões de sucesso e mostra que o ',
      'verdadeiro',
      ' sentido da vida nunca chega tarde.'
    ]
  },
  { 
    id: 12, 
    ...
    sinopse: [
      'Este vídeo mostra como ',
      'crenças',
      ' moldam a realidade, revelando que mudar a ',
      'consciência',
      ' é mudar o reflexo que você vive.'
    ]
  },
];
